...
<p className='text-blau-900 text-xs'> {item.main.humidity}%</p>
<p className='text-red-900 text-xs'>Humidity {item.dt_txt}</p>
<p className='text-blau-900 text-sm'>Temperature: {item.main.temp}C</p>
